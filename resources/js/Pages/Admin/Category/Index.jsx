...
export default function Index(props) {
    ...
    function handleDelete(e) {
        e.preventDefault()
        destroy(route("category.destroy", e.target.id));
    }
        ...
        >
            ...
            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <Link href={route("category.create")} type="button"
                    ...
                    <div className="relative overflow-x-auto mb-6">
                        <table className="w-full text-sm text-left text-gray-500">
                            ...
                            <tbody>
                                {
                                    props.categories.data.map((item, key) =>
                    ...
                    <Pagination meta={props.categories.meta} />
                </div>
            </div>
        </AuthenticatedLayout>
    )
