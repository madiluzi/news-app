...
export default function Sidenav({ auth }) {
    ...
    return (
        <>
            <button data-drawer-target="default-sidebar" data-drawer-toggle="default-sidebar" aria-controls="default-sidebar" type="button" class="hidden items-center p-2 mt-2 ml-3 text-sm text-gray-500 rounded-lg hover:bg-gray-100 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:focus:ring-gray-600">
            ...
            <aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
                <div class="h-full overflow-y-auto bg-gray-900">
                    <Link href={route('dashboard')} class="h-16 flex w-full items-center justify-center mb-5">
                        <ApplicationLogo className="block h-9 w-auto fill-current text-white" />
                    </Link>
                    <ul class="space-y-2 font-medium">
                        <li className='px-3'>
                            <Link href={route('dashboard')} class="flex items-center p-2 text-white rounded-lg hover:bg-gray-100 hover:text-gray-900">
                        ...
                        <li className='px-3'>
                            <Link href={route('news.index')} class="flex items-center p-2 text-white rounded-lg hover:bg-gray-100 hover:text-gray-900">
                        ...
                        <li className='px-3'>
                            <Link href={route('category.index')} class="flex items-center p-2 text-white rounded-lg hover:bg-gray-100 hover:text-gray-900">
                        ...
                        <li className='px-3'>
                            <Link href={route('tag.index')} class="flex items-center p-2 text-white rounded-lg hover:bg-gray-100 hover:text-gray-900">
                        ...
                        <li className='px-3'>
                            <Link href={route('media.index')} class="flex items-center p-2 text-white rounded-lg hover:bg-gray-100 hover:text-gray-900">
